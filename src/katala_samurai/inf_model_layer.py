    ...
    base_model = {
        ...
        "expansion_plan": {
            ...
            "design_philosophy": {
                ...
                "L1_ledger_file": "inf-Coding/inf-Coding-Assist/L1_ledger_20260307_v2_enumerated.json",
                "note": "This is the conceptual baseline before downstream gate narrowing.",
            },
            "layer_contracts": {
                "L_to_S": ["geom_id", "schema_version", "provenance"],
                "S_to_P": ["binary_hash_sha256", "decode_spec", "source_ref"],
                "P_to_M": ["test_result", "gate_result", "reproducibility_tag"],
            },
            "history_policy": {
                "S_append_only": True,
                "P_transformation_log_required": True,
                "M_keep_rejected_history": True,
            },
            "final_authority": {
                "decision_gate": "L3_top_recovery_layer",
                "requires": ["local_euclid_recovery", "limit_euclid_recovery"],
                "note": "Final acceptance authority is fixed at L3 recovery gate.",
            },
