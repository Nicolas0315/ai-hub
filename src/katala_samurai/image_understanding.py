...
MANIPULATION_CONFIDENCE_HIGH = 0.7
MANIPULATION_CONFIDENCE_LOW = 0.3
AI_GENERATION_SIZE_THRESHOLD = 1024
SUSPICIOUS_CLAIM_PENALTY = 0.15
PRESSURE_WORD_PENALTY = 0.08
MIN_VALID_DIMENSION = 0
ENTROPY_LOW_THRESHOLD = 3.0
ENTROPY_HIGH_THRESHOLD = 7.5
COLOR_ANALYSIS_SAMPLE_MAX = 100000
EXIF_STRIPPED_PENALTY = 0.15
CLIP_TEMPERATURE_SCALE = 100
DEFAULT_CLAIM_SCORE = 0.5
SUSPICIOUS_SCORE_THRESHOLD = 0.5
# Image dimension thresholds
TYPICAL_AI_WIDTHS = {256, 512, 768, 1024}
EXIF_PREVIEW_TRUNCATE = 200
CLAIM_TEXT_TRUNCATE = 80
MANIPULATION_INDICATOR_MAX = 50
COLOR_CHANNEL_MAX = 256
VERY_LOW_CONFIDENCE = 0.1
MODERATE_CONFIDENCE = 0.2
